    ...
    <div className="space-y-8">
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900 p-5">
        <p className="text-sm leading-7 text-slate-300">
          {locale === "tr"
            ? "AI araç dizininde fiyat modeli, kategori uyumu ve kullanım senaryosu birlikte değerlendirilmelidir. Bu sayfa, ekiplerin tek tek araç sayfalarına gitmeden önce hızlı bir ön eleme yapması için tasarlandı. Her kartta araç tipi, fiyat sınıfı ve detaylı açıklama görerek daha bilinçli seçim yapabilirsiniz. Özellikle içerik, video, coding ve productivity akışları için farklı araçların güçlü olduğu noktalar değişir. Bu nedenle önce kategoriye göre filtreleyin, sonra shortlist oluşturup tool detay ve compare sayfalarına geçin. Bu akış, gereksiz lisans maliyetini azaltır ve ekip için doğru ürüne daha hızlı ulaşmanızı sağlar."
